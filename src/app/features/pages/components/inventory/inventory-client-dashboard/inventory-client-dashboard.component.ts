...
@Component({
  selector: 'app-inventory-client-dashboard',
  templateUrl: './inventory-client-dashboard.component.html',
  styleUrls: ['./inventory-client-dashboard.component.css'],
})
export class InventoryClientDashboardComponent implements OnInit {
  ...
  constructor(public mockDataAPIService: MockData) {
    this.data = this.mockDataAPIService.getTestingChartData()
  }
